...
public class KlasRestaurantProblemDetailsFactory : ProblemDetailsFactory
{
    private readonly ApiBehaviorOptions _options;

    public KlasRestaurantProblemDetailsFactory(IOptions<ApiBehaviorOptions> options)
    {
        ...
        string? instance = null)
    {
        ...
        if (title != null)
        {
            //fo validation pronlem details, don't overwrite the default title with null
